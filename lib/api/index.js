...
API.createContainer = function(nodeID, containerName, dKey, cb){
  ...
  httpClient.createRequest('POST', '/0000000000000001/v1_0/remoteCSE-'+nodeID, headers, body)
            .request(function(err,result){
...
API.createContentInstance = function(nodeID, containerName, dKey, value){
  ...
  var path = '/0000000000000001/v1_0/remoteCSE-'+ nodeID+ '/container-'+ containerName;
...
API.updateExecInstance = function(nodeID, mgmtCmdPrefix,dKey, ei){
  ...
  var body = {};
  var path = '/0000000000000001/v1_0/mgmtCmd-'+ nodeID + '_' + mgmtCmdPrefix + '/execInstance-'+ei;
...
API.getLatestContainer = function(nodeID, containerName, cb){
  ...
  var path = '/0000000000000001/v1_0/remoteCSE-'+ nodeID+ '/container-'+ containerName + '/latest';
...
API.reqMgmtCmd = function(nodeID, mgmtCmdPrefix, cmd, nodeRI, cb){
  var headers = {
    uKey : config.uKey,
    'X-M2M-Origin': config.appID,
  };
  ...
  var path = '/0000000000000001/v1_0/mgmtCmd-' +nodeID + '_' + mgmtCmdPrefix;
  httpClient.createRequest('PUT', path, headers, body)
            .request(function(err,result){
    if(err) return cb(err);
		var data = JSON.parse(result.data);
...
API.getMgmtResults = function(nodeID, mgmtCmdPrefix, resourceID, cb){
  ...
  var path = '/0000000000000001/v1_0/mgmtCmd-'+nodeID + '_' + mgmtCmdPrefix+ '/execInstance-' + resourceID;
  httpClient.createRequest('GET', path, headers, null)
            .request(function(err,result){
    if(err) return cb(err);
    var data = JSON.parse(result.data);
